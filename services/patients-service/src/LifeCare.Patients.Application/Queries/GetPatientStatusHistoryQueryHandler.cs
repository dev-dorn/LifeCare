...
public class
    GetPatientStatusHistoryQueryHandler : IRequestHandler<GetPatientStatusHistoryQuery, List<PatientStatusHistory>>
{
    ...
    public async Task<List<PatientStatusHistory>> Handle(GetPatientStatusHistoryQuery request,
