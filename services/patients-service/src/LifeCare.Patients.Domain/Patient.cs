...
public class Patient : AggregateRoot
{
    ...
    )
    {
        ...
        if (patient.RequiresGuardian) patient.AssignGuardian(guardianName, guardianRelationship, guardianPhone);
    ...
    public void UpdateBasicInfo(string shifNumber, string? nationalId, string firstName, string lastName, string gender,
        DateTime dob)
    {
